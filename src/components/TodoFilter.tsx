    ...
    <div className='p-4 mx-4 mt-2 flex flex-col gap-2 bg-primary-dark border-primary-light border-2 rounded bg-se items-center justify-around'>
      <div className='flex justify-around gap-4 px-4'>
          <div className='flex flex-col gap-2 text-center'>
            ...
            <select value={currentFilters.category} onChange={handleCategoryChange} className='custom-width border-primary-light border-2 rounded-xl w-[10rem] focus:outline-none hover:border-lemon transition-all'>
        ...
        <option value="private" className='bg-secondary-dark text-left'>private</option>
          ...
          <div className='flex flex-col gap-2 text-center items-center'>
            <h4 className='text-sm italic'>by completion</h4>
             <select value={currentFilters.completed} onChange={handleCompletionChange} className='custom-width border-primary-light border-2 rounded-xl w-[10rem] text-center focus:outline-none hover:border-lemon transition-all'>
        <option value="all" className='bg-secondary-dark text-left'>all</option>
