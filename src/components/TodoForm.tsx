...
const TodoForm:React.FC = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='p-4 mx-4 mt-2 flex flex-col gap-2 border-primary-light border-2 rounded bg-secondary-dark'>
      ...
      <div className='flex justify-around mt-2 mx-4 gap-4'>
        <div className='flex  justify-around gap-4 items-center'>
          ...
          <select value={category} onChange={(e) => setCategory(e.target.value as 'family' | 'work' | 'private')} className='w-[8rem]  border-primary-light border-2 rounded-xl'>
      ...
      <button type='submit' className='w-[8rem] border-primary-light border-2 rounded-2xl bg-confirm-button'>Add Task</button>
      </div>
